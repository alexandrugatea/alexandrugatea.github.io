...
const mapsData = [
    ...
    },
    {
        ...
        'src': 'images/portfolio/maps/port_maps_blender.png',
       'project-text': `
        <h2>
...
const brandData = [
    {
        ...
        'src': 'images/portfolio/brand/port_logo_atletic.png',
       'project-text': `
        <h2>
            Brand design
        </h2>
    ...
    },
    {
        ...
        'src': 'images/portfolio/brand/port_logo_city.png',
       'project-text': `
        <h2>
            Brand design
        </h2>
    ...
    },
    {
        ...
        'size': '1080-1080',
        'captionID': 'logoCoop',
        'src': 'images/portfolio/brand/port_logo_coop.png',
       'project-text': `
        <h2>
            Logo design
        </h2>
    ...
    },
    {
        ...
        'size': '1440-1080',
        'captionID': 'logoGames',
        'src': 'images/portfolio/brand/port_logo_games.png',
       'project-text': `
        <h2>
            Brand design
        </h2>
    ...
    },
    {
        ...
        'src': 'images/portfolio/brand/port_logo_keytana.png',
       'project-text': `
        <h2>
            Logo Design
        </h2>
...

    {
        ...
        'size': '1080-1080',
        'captionID': 'logoOM',
        'src': 'images/portfolio/brand/port_logo_oman.png',
       'project-text': `
        <h2>
            Logo Design
        </h2>
    ...
    },
    {
        ...
        'src': 'images/portfolio/brand/port_logo_reco.png',
       'project-text': `
        <h2>
            Logo Design
        </h2>
    ...
    },
    {
        ...
        'src': 'images/portfolio/brand/port_logo_wanted.png',
       'project-text': `
        <h2>
            Brand design
        </h2>
