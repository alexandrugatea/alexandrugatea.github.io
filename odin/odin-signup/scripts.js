...
document.addEventListener('DOMContentLoaded', function() {
    ...
    signUpform.addEventListener('submit', function(event) {
        ...
        isValid &= validateInput(signUpConfirmPassword, (value) => value === signUpPassword.value && validatePassword(value));
    ...
    signUpform.addEventListener('reset', function() { resetAll(this) });
    signInform.addEventListener('reset', function() { resetAll(this) });
