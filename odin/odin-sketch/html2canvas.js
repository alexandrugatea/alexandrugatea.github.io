    ...
    ***************************************************************************** */ var r = function (A, e) {
		...
		es = function (A) {
			...
			(this.topLeftBorderDoubleOuterBox =
				...
				(this.topRightBorderBox =
					0 < n || 0 < s ? ss(t.left + a, t.top, n, s, As.TOP_RIGHT) : new Zn(t.left + t.width, t.top)),
				(this.bottomRightBorderBox =
					0 < o || 0 < i
						? ss(t.left + w, t.top + g, o, i, As.BOTTOM_RIGHT)
						: new Zn(t.left + t.width, t.top + t.height)),
				(this.bottomLeftBorderBox =
					0 < Q || 0 < c ? ss(t.left, t.top + U, Q, c, As.BOTTOM_LEFT) : new Zn(t.left, t.top + t.height)),
	...
	var hs = function (Q, c, a, g) {
		...
		fs = function (A, e) {
			var t = [];
			return (
				$n(A) ? t.push(A.subdivide(0.5, !1)) : t.push(A), $n(e) ? t.push(e.subdivide(0.5, !0)) : t.push(e), t
			);
		},
		Hs = function (A, e, t, r) {
			var B = [];
	...
	var Ls,
		...
		bs =
			...
			(Ds.prototype.resizeImage = function (A, e, t) {
				...
				var r = (null !== (r = this.canvas.ownerDocument) && void 0 !== r ? r : document).createElement(
					"canvas"
				);
				return (
							...
							B <= 2 * n
								...
								: B <= 2 * n + s
									...
									: ((Q = Math.floor((B + s) / (n + s))),
										(i = (B - Q * n) / (Q - 1)),
										(s =
											(Q = (B - (Q + 1) * n) / Q) <= 0 || Math.abs(s - i) < Math.abs(s - Q)
												? i
												: Q)),
